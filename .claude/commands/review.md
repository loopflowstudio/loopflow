...
4. Read STYLE.md and compare the diff against it
...
- No `Args:`/`Returns:` docstrings when types are clear
- Imports at top of file, never inline
- Private functions prefixed with `_`
- Mocks prevent side effects; tests assert on results, not mock calls
- One implementation—no `_v2`, `_old`, `_new` suffixes
