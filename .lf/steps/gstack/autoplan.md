...
gstack:autoplan reads the full CEO, design, eng, and DX review skill files from disk and follows
...
- `.lf/steps/gstack/plan-devex-review.md` (only if DX scope detected)
