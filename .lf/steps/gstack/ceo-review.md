...
Read the `gstack:office-hours` skill file at `.lf/steps/gstack/office-hours.md` using the Read tool.

**If unreadable:** Skip with "Could not load gstack:office-hours — skipping." and continue.
