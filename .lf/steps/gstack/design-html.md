...
description: 'Design finalization: generates production-quality Pretext-native HTML/CSS.
  ...
  Works with approved mockups from /design-shotgun, CEO plans from gstack:ceo-review,

  design review context from gstack:design-review, or from scratch with a user
...
Use AskUserQuestion:
> Found [CEO plan from gstack:ceo-review | design review variants from gstack:design-review | both]
...
> A) Run gstack:ceo-review first — think through the product strategy before designing
> B) Run gstack:design-review first — design review with visual mockups
