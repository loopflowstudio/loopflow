...
public enum PromptSource: Sendable, Hashable {
...
public struct PromptCard: Sendable, Identifiable, Hashable {
    public var id: String { name }

    public let name: String
    public let content: String
    public let defaultMode: RunMode
    public let source: PromptSource

    public init(name: String, content: String, defaultMode: RunMode, source: PromptSource = .local) {
        self.name = name
    ...
    public var isExternalSkill: Bool {
        source.isExternal
    }
