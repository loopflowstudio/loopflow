...
public struct PipelineService: @unchecked Sendable {
    public init() {}
    ...
    public func loadPipelines(from repoURL: URL) -> [PipelineDef] {
    ...
    public func loadPipeline(from url: URL) -> PipelineDef? {
    ...
    public func loadPipeline(named name: String, in repoURL: URL) -> PipelineDef? {
    ...
    public func savePipeline(_ pipeline: PipelineDef, in repoURL: URL) throws {
        let pipelinesDir = repoURL.appendingPathComponent(".lf/pipelines")
    ...
    public func deletePipeline(named name: String, in repoURL: URL) throws {
        let pipelineURL = repoURL.appendingPathComponent(".lf/pipelines/\(name).yaml")
    ...
    public func parsePipelineYAML(_ contents: String, name: String) -> PipelineDef? {
    ...
    public func serializePipelineYAML(_ pipeline: PipelineDef) -> String {
