...
struct ResultsService {

    func captureBaseline(sessionId: String, worktree: URL) async -> SessionBaseline {
    ...
    func loadDiffPreview(for file: FileChange, baselineSHA: String, in worktree: URL) async -> String? {
