// Worktree model. Maps to LoopflowSwift/LoopflowCore/Models/Worktree.swift
...
// Extend interface with computed properties
declare module './worktree' {
  interface Worktree {
    readonly shortName: string
    readonly commitsText: string
  }
}

Object.defineProperty(Object.prototype, 'shortName', {
  get(this: Worktree) { return shortName(this) },
  configurable: true,
})

Object.defineProperty(Object.prototype, 'commitsText', {
  get(this: Worktree) { return commitsText(this) },
  configurable: true,
})
