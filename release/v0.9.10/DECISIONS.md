...
If this directory exists, `lf op release run` promotes it to `release/v<version>/` and feeds this file into the release-notes skill as primary source material.
