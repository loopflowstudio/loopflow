...
| [01b-ops-parity](../../scratch/rust-parity.md) | Ops workflow logic matches Python | ✅ Done |
| [01c-testing-and-rollout](../../scratch/rust-testing-rollout.md) | E2E smoke test, LF_RUST env var, binary bundling | 🔜 Next |
...
- Ops parity verified: Rust `lf ops` matches Python behavior via trace-based comparison

**The gap:** Testing infrastructure and rollout strategy needed before Rust becomes primary. See [scratch/rust-testing-rollout.md](../../scratch/rust-testing-rollout.md).
