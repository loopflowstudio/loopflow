...
| [02c-grpc-events](02c-grpc-events.md) | Event emission via WebSocket, CollapsePRs |
...
- `lfd` has infrastructure (HTTP, storage, loops) but isn't the primary execution path
