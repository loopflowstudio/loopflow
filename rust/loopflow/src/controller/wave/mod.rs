...
use self::chat::ChatBacking;
use self::runtime::WaveRuntime;
...
fn resident_command(
    ...
    command
        ...
        .env("PATH", crate::controller::wave::runner::path_for_children())
...
mod tests {
    ...
    use crate::controller::wave::chat::{
        ChatHistorySnapshot, PostMessageResponse, WaveChatMessage,
    };
    use crate::controller::wave::journal::MessageOp;
    use crate::controller::wave::server::ResidentDoor;
    use crate::controller::wave::wire::{ResidentDelta, RESIDENT_TOKEN_HEADER};
    ...
    async fn health_splits_listener_liveness_from_the_loop() {
        ...
        runtime.transition(
            crate::controller::wave::state::LoopState::Failed {
