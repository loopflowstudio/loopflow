...
static BUILTIN_DIRECTION_GROUPS: std::sync::LazyLock<
    std::collections::HashMap<&'static str, &'static [&'static str]>,
> = std::sync::LazyLock::new(|| {
    let mut groups: std::collections::HashMap<&'static str, &'static [&'static str]> =
        std::collections::HashMap::new();
    groups.insert(
        "roles",
        &["ceo", "designer", "infra-engineer", "product-engineer"],
    );
    groups.insert("values", &["craft", "flow", "scale"]);
    groups
});
