...
gstack:eng-review or gstack:design-review instead." Exit gracefully.
...
**Recommend gstack:eng-review if eng review is not skipped globally** — DX issues often
...
**Suggest gstack:design-review if user-facing UI exists** — DX review focuses on
...
- **B)** Run gstack:design-review (only if UI scope detected)
