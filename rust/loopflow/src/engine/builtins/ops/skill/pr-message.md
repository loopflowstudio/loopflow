...
link, PR sequence, and merge disposition after generation. Do not invent or
repeat those facts from branch names or commit messages. Controller phase is
not reviewer-facing Task context.
