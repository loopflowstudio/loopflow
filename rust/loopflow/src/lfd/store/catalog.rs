...
const QUERY_DEFS: [QueryDef; QUERY_COUNT] = [
    ...
    QueryDef {
        template: "SELECT id, wave_id, kind, cron, last_main_sha, last_triggered_at, created_at, enabled\n             FROM stimuli ORDER BY created_at",
        sqlite_override: None,
        postgres_override: None,
    },
    QueryDef {
    ...
    QueryDef {
        template: "INSERT INTO stimuli (id, wave_id, kind, cron, last_main_sha, last_triggered_at, created_at, enabled)\n             VALUES ({p1}, {p2}, {p3}, {p4}, {p5}, {p6}, {p7}, {p8})",
        sqlite_override: None,
        postgres_override: None,
    },
    QueryDef {
        template: "UPDATE stimuli SET\n                kind = {p1}, cron = {p2}, last_main_sha = {p3},\n                last_triggered_at = {p4}, enabled = {p5}\n             WHERE id = {p6}",
        sqlite_override: None,
        postgres_override: None,
    },
    QueryDef {
    ...
    QueryDef {
        template: "DELETE FROM stimuli WHERE wave_id = {p1}",
        sqlite_override: None,
        postgres_override: None,
    },
    QueryDef {
        template: "SELECT id, wave_id, stimulus_id, from_sha, to_sha, queued_at\n             FROM pending_activations WHERE wave_id = {p1} ORDER BY queued_at",
        sqlite_override: None,
        postgres_override: None,
    },
    QueryDef {
        template: "INSERT INTO pending_activations (id, wave_id, stimulus_id, from_sha, to_sha, queued_at)\n             VALUES ({p1}, {p2}, {p3}, {p4}, {p5}, {p6})",
        sqlite_override: None,
        postgres_override: None,
    },
    QueryDef {
        template: "UPDATE pending_activations SET from_sha = {p1}, to_sha = {p2} WHERE id = {p3}",
        sqlite_override: None,
        postgres_override: None,
    },
    QueryDef {
