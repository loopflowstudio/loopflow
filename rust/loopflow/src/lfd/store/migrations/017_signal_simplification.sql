...
DROP INDEX IF EXISTS idx_runs_wave_id_kind_status;
ALTER TABLE runs DROP COLUMN run_kind;
ALTER TABLE runs DROP COLUMN ci_fix_kind;
CREATE INDEX IF NOT EXISTS idx_runs_wave_id_status
ON runs(wave_id, status, started_at);
