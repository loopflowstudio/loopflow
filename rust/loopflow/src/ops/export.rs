    ...
    fn export_order_reverses_bootstrap_creates() {
        let items = vec![
            WaveItem {
                ...
                order: crate::ops::ingest::WaveItemOrder::LegacyStage(1),
                slug: "one".to_string(),
            },
            WaveItem {
                filename: "02-two.md".to_string(),
                order: crate::ops::ingest::WaveItemOrder::LegacyStage(2),
                slug: "two".to_string(),
            },
            WaveItem {
                filename: "03-three.md".to_string(),
                order: crate::ops::ingest::WaveItemOrder::LegacyStage(3),
