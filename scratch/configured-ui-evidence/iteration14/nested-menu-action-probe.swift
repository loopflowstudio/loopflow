...
setbuf(stdout, nil)
let proofRoot = "/tmp/loo291-iteration14-final-result"
            ...
            func selectSession() throws {
                ...
                while Date()<deadline {
                    ...
                    for picker in pickers {
                        print("SESSION_PICKER",text(picker,"AXDescription"))
                        guard AXUIElementPerformAction(picker,kAXShowMenuAction as CFString) == .success else { continue }
                        settle(0.3)
