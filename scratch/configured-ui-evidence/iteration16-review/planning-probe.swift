...
NSWorkspace.shared.openApplication(at: URL(fileURLWithPath: "/tmp/loo291-iteration16/Loopflow Proof.app"), configuration: configuration) { app, error in
    ...
    DispatchQueue.main.async {
        ...
        print(succeeded ? "PASS: configured planning, exact Session access and shared Work path observed; no Session interaction" : "FAIL: configured scoped count not established")
    }
}
