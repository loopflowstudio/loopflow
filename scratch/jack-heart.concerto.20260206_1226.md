# Design: wave status, run snapshots, name lookup index

## What to build
Implement three simplification opportunities in lfd + clients: first-class wave status, run configuration snapshots, and name-indexed wave lookup.
