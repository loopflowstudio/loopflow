...
- Palette sessions intentionally keep tmux alive after flow completion, so users can accumulate shells. Existing cancel/close kills the lfd session; dogfooding should reveal whether an idle sweep is needed.
