...
Expected result: all five redesign waves are created, and `lfq show redesign` reports `flow: tend`, `status: idle`, the four member `wave/.../` paths, and an absolute repo path.
