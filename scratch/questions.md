...
- I assumed remote HTTP access should be blocked when loopflow.studio registration isn't enabled or hasn't completed. Is there a desired fallback for remote access without registration?
