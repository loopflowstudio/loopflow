...
---
Where could your area go next? What's the natural evolution?

## Scope

The included context defines your area of responsibility. Identify expansion opportunities within that scope. If given `src/api/`, think about API evolution—not unrelated features elsewhere. You own this area; propose what would make it better.
