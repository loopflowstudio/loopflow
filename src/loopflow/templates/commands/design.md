...
**Important:** The `.design/` directory must be at the repository root, not in subdirectories. If working on files in a subdirectory, still write design docs to the root `.design/` folder.
