...
extension Notification.Name {
    ...
    static let deleteSelectedWave = Notification.Name("deleteSelectedWave")
    static let retrySelectedWave = Notification.Name("retrySelectedWave")
    static let stopSelectedWave = Notification.Name("stopSelectedWave")
    static let landSelectedWave = Notification.Name("landSelectedWave")
    static let nextSelectedWave = Notification.Name("nextSelectedWave")
    static let openWaveTerminal = Notification.Name("openWaveTerminal")
    static let openWaveIDE = Notification.Name("openWaveIDE")
    static let openWaveInFinder = Notification.Name("openWaveInFinder")
