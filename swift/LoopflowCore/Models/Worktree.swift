...
public struct Worktree: Sendable, Identifiable, Hashable, Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case hasCodeWorkspace, isRebasing, isMerging, hasDiff, recentSteps, staleness, ciStatus
    }
...
public extension Worktree {
    init(from json: WorktreeJSON, hasCodeWorkspace: Bool = false, recentSteps: [StepRun] = []) {
        self.path = json.path
