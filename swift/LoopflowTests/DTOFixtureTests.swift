...
struct DTOFixtureTests {
    ...
    func waveDetailFixturePreservesHierarchy() throws {
        ...
        #expect(detail.unavailableProjects[0].workId == "proj_3998f8611e9c9069f53c44dc831803d7")
        #expect(detail.unavailableProjects[0].projectId == "0b13d98e-800e-49a3-a778-6fb13ac0f03a")
        #expect(detail.unavailableProjects[0].projectSlug == "wave-chat")
