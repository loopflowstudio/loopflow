---
linear_id: 22dd76a4-aed4-4ee6-a8b7-696930aef1d8
---
# Beat Synthesizer
...
power users can edit the YAML directly or the chord's garden flow can
propose grid mutations.

## What this enables

More beats = more autonomy between garden check-ins. Fewer beats = tighter
feedback. Removing waves from beats staggers work. Adding garden beats
increases oversight. The grid is direct manipulation — what you see is
what runs.

## Rhythms

A rhythm like `4:1` means 4 build beats per garden beat — a 5-beat grid.
...
there — remove waves from beats to stagger, add garden beats for more
...
preset that generates them — 5 beats, garden on 1, all active waves on
...
Waves on the same beat run in parallel. `garden` on a beat means the chord's
own garden flow runs.
