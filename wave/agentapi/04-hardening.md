...
- **Concurrent clients**: multiple Concerto instances can subscribe to the same broadcast channel. Input routing is already single-harness — no conflict. Need to verify broadcast fan-out works under load.
