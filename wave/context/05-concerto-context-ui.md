...
The audit breakdown (sprint 01) produces structured data about what's in the prompt. The CLI prints it as a table. Concerto should surface the same information visually — it's the primary way many users interact with loopflow, and context visibility shouldn't be CLI-only.
