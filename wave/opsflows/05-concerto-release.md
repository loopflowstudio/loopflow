...
1. **Release config** — per-repo settings for cadence (cron expression), toggle on/off. The wave configs (`wave/release-patch/`, `wave/release-minor/`) are the source of truth; Concerto reads and writes them.
