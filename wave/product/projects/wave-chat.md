...
- Across one month of releases, `lf chat` remains the sole CLI owner of the human thread and `lf radio sub` remains bus-only; CLI help, docs, and surface integrations expose zero overlapping chat commands or thread/bus fusions.
