...
Add remote-safe APIs for file browsing and step/flow/direction metadata after auth rollout stabilizes.

## What exists after this

Concerto can inspect remote worktrees and drive typeahead/config UX through lfd HTTP APIs, without local filesystem assumptions.
