...
- **02-inline-glance**: next implementation target. Inline diff/file/roadmap visibility in Concerto with lightweight expansion and deep-dive links out to GitHub/Cursor.
